...
/a (Status: 301)
```
at this point I knew there was a `ctf.thm/r/a/b/b/i/t` path, and with each letter I got a static pages telling me I was on the right path

the last page had a picture hinting there is something hidden in there, examining the source code showed what appeared to be the ssh credentiels for the user `alice`
